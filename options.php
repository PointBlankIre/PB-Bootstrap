...
"desc" => "HTML or text can be inserted into the header. You might add a site announcement.",
"id" => "header_extra",
"std" => "",
"type" => "textarea"); 
...
"desc" => "Your Facebook Page Address.",
"id" => "facebook_adr",
"std" => "http://www.facebook.com/",
"type" => "text");

	$options[] = array( "name" => "Twitter Address",
"desc" => "Your Twitter Address.",
"id" => "twitter_adr",
...
/*
	...
	$options[] = array( "name" => "Posted on Options",
"desc" => "Uncheck this box to hide the date and author of posts, e.g Posted on November 17, 2011 by admin",
"id" => "meta_checkbox",
"std" => "1",
"type" => "checkbox");

	$options[] = array( "name" => "Posted in Options",
"desc" => "Uncheck this box to hide the category for a post, e.g This entry was posted in Uncategorized. Bookmark the permalink",
"id" => "posted_checkbox",
"std" => "1",
"type" => "checkbox");		
